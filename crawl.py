...
# 1. 크롤링 함수
# =========================================================
async def crawl_jobkorea(keyword, start_page=1, end_page=1):
    job_list = []
    ...
    async with async_playwright() as p:
        ...
        for current_page in range(start_page, end_page + 1):
            ...
            await page.goto(f"{url}&Page_No={current_page}")
...
async def main():
    ...
    # 2) 크롤링 실행
    result = await crawl_jobkorea(keyword, start_page=start_page, end_page=end_page)
